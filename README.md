...
- **`agents/`** — persistent reasoning framework (governance, council, journal). See `agents/agents/README.md`.
...
- **`claude-skills/`** — vendored third-party reference skills; do **not** import (see `CLAUDE.md`).

Agent instructions: `CLAUDE.md`. Project mission: `context/00_PROJECT_MISSION.md`. Filesystem rules: `PROJECT_STRUCTURE.md`. Development rules: `DEVELOPMENT_RULES.md`.
