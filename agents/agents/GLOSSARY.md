...
The numbered document at `context/02_SURVIVING_HYPOTHESES.md`. Each hypothesis carries a source session, claim, and current status. Distinct from the journal — this file tracks *claims that drive the project*; the journal tracks *decisions made*. Hypotheses are about uncertainty to manage, not decisions already taken.
...
- `agents/agents/REFERENCES.md`
- `agents/agents/journal/README.md`
- `agents/agents/journal/2026-06-19-r1-problem-ranking-application.md`
- `context/01_CURRENT_STATE.md`
- `context/02_SURVIVING_HYPOTHESES.md`
- `context/03_RESEARCH_BACKLOG.md`
- `PROJECT_HISTORY.md`
