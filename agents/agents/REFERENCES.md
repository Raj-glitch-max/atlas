...
Promotion rules follow `agents/agents/GOVERNANCE.md` §8: a Temporary becomes Core only after 10+ journal entries cite it as load-bearing AND founder decides. Otherwise retire to Reference or Remove on demotion.
